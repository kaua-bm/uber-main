        ...
        <div className={styles.container}>
          <div className={styles.topRow}>
            <div className={styles.brandCol}>
              ...
              <a href="/pagina-nao-existe" className={styles.helpLink}>
            ...
            {Object.entries(footerLinks).map(([category, links]) => (
              <div key={category} className={styles.linkColumn}>
                ...
                <ul className={styles.linkList}>
                  {links.map((link) => (
                    <li key={link}>
                      <a href="/pagina-nao-existe" className={styles.footerLink}>
                        {link}
                      </a>
                    </li>
                  ))}
          ...
          <div className={styles.bottomRow}>
            <div className={styles.socialLinks}>
              {/* LinkedIn */}
              <a href="/pagina-nao-existe" className={styles.socialIcon} aria-label="LinkedIn">
              ...
              {/* YouTube */}
              <a href="/pagina-nao-existe" className={styles.socialIcon} aria-label="YouTube">
                <svg width="20" height="20" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M23.495 6.205a3.007 3.007 0 0 0-2.088-2.088c-1.87-.501-9.396-.501-9.396-.501s-7.507-.01-9.396.501A3.007 3.007 0 0 0 .527 6.205a31.247 31.247 0 0 0-.522 5.805 31.247 31.247 0 0 0 .522 5.783 3.007 3.007 0 0 0 2.088 2.088c1.868.502 9.396.502 9.396.502s7.506 0 9.396-.502a3.007 3.007 0 0 0 2.088-2.088 31.247 31.247 0 0 0 .5-5.783 31.247 31.247 0 0 0-.5-5.805zM9.609 15.601V8.408l6.264 3.602z"/>
                </svg>
              </a>
              {/* Instagram */}
              <a href="/pagina-nao-existe" className={styles.socialIcon} aria-label="Instagram">
                <svg width="20" height="20" fill="currentColor" viewBox="0 0 24 24">
              ...
              {/* X / Twitter */}
              <a href="/pagina-nao-existe" className={styles.socialIcon} aria-label="X">
                <svg width="20" height="20" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div className={styles.localeRow}>
              <a href="/pagina-nao-existe" className={styles.localeBtn}>
                <Globe size={16} />
                Português (Brasil)
              </a>
              <a href="/pagina-nao-existe" className={styles.localeBtn}>
          ...
          <div className={styles.appStores}>
            <a href="/pagina-nao-existe" className={styles.storeBtn}>
              <img
          ...
          <div className={styles.legal}>
            ...
            <div className={styles.legalLinks}>
              <a href="/pagina-nao-existe">Privacidade</a>
              <a href="/pagina-nao-existe">Acessibilidade</a>
              <a href="/pagina-nao-existe">Termos</a>
            </div>
          </div>
        </div>
      </div>
